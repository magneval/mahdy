...
let Mazdada = sprites.create(img`
. . . . . . . . . . . . . . 
e e e . . . . e e e . . . . 
c d d c . . c d d c . . . . 
c b d d f f d d b c . . . . 
...
d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d d 
`)
controller.moveSprite(Mazdada)
Bob.setPosition(0, Math.randomRange(10, 160))
Lint.setPosition(0, Math.randomRange(10, 160))
Lint.setPosition(0, Math.randomRange(0, 160))
Babydy.setPosition(0, 0)
Lint.setPosition(0, 0)
Mazdada.setVelocity(5, 5)
Bob.follow(Mazdada, Math.randomRange(10, 30))
Lint.follow(Mazdada, Math.randomRange(10, 30))
Babydy.follow(Mazdada, Math.randomRange(10, 30))
Mazdada.setFlag(SpriteFlag.StayInScreen, true)
info.setLife(3)
